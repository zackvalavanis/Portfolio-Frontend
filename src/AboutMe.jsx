    ...
    <div className='about-me-container'>
      ...
      <CardHeader
            ...
            <CardMedia
              component="img"
              sx={{ height: 40, width: 40 }} // Adjust size here
              image="/Images/Accenture-Logo.png"
              alt="Accenture Logo"
            />
            </a>
          }
        ...
        <CardHeader
          avatar={
            <a href='https://www.linkedin.com/company/advantage-futures/posts/?feedView=all' target="_blank" rel="noopener noreferrer">
              ...
              component="img"
              sx={{ height: 40, width: 40 }} // Adjust size here
              image="/Images/Advantage-Futures-Logo.jpeg"
        ...
        <CardHeader
          avatar={ 
            ...
            <CardMedia 
              component="img"
              sx={{ height: 40, width: 40 }} // Adjust size here
              image="/Images/Onshore-Logo.jpeg"
              alt="OnShore Logo"
            />
            </a>
          }
      ...
      <a href='/ZackValavanisResume.pdf' className='resume-button'>Resume</a>
    </div>
  );
}
